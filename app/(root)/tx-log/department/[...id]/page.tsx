  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div className="text-left font-medium">
        {action === "lending" ?
          <Badge variant="secondary">Mượn</Badge>
          :
      ...
      {txLog && (
        <div>
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold mb-4 text-gray-600 font-sans">Lịch sử Mượn / Trả Đồ</h2>
          ...
          <div className="flex flex-1 justify-between p-4 mb-4 rounded-md border">
            ...
            <div className="flex items-center">
              ...
              <p className="text-xl font-bold text-red-600">{txLog.exported - txLog.returned}</p>
            </div>
            <div className="flex items-center">
